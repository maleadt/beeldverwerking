...
% Title.
% ------
\title{EXTRACTING LICENCE PLATES FROM REALTIME VIDEO}
%
% Single address.
% ---------------
\name{Aswin Coolsaat, Bart Wulteputte, Bert Lerno, Frederik De Jaegher, Ward Becelaere
\thanks{Thanks to University College Ghent for funding.}}
\address{University College Ghent\\Applied Engineering\\Campus Schoonmeersen, Schoonmeersstraat 52, 9000 Gent}
